...
--
-- Name: usuarios Delete own user; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Delete own user" ON public.usuarios FOR DELETE TO authenticated USING ((auth.uid() = id));
...
--
-- Name: usuarios Insert own user; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Insert own user" ON public.usuarios FOR INSERT TO authenticated WITH CHECK ((auth.uid() = id));
...
--
-- Name: comunidades Manage own communities; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Manage own communities" ON public.comunidades TO authenticated USING ((criador_id = auth.uid()));
...
--
-- Name: usuarios Update own user; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Update own user" ON public.usuarios FOR UPDATE TO authenticated USING ((auth.uid() = id));
...
--
-- Name: comunidades View public communities; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "View public communities" ON public.comunidades FOR SELECT USING ((((tipo)::text = 'publica'::text) OR (criador_id = auth.uid())));
...
--
-- Name: usuarios View public profiles; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "View public profiles" ON public.usuarios FOR SELECT USING (true);
